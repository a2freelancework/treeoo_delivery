...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  void initState() {
    super.initState();
    _email = TextEditingController(text: 'ashim.march@gmail.com');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<AuthBloc, AuthState>(
      listenWhen: (_, state) =>  state is AuthVerificationSentState || state is AuthError,
      listener: (_, state) {
            ...
            child: Column(
              ...
              children: [
                  ...
                  return GestureDetector(
                    onTap: () {
                      if (_formKey.currentState?.validate() ?? false) {
                        ...
                        context.read<AuthBloc>().add(AuthResetPasswordEvent(_email.text));
                      }
                    },
                ...
                InkWell(
                  ...
                  child: const AuthPageTexts(text: 'Go to Login'),
                ),
